...
лежит только локально и в репозиторий не попадает. Если расширение когда-нибудь поедет в
Chrome Web Store, поле `key` из манифеста нужно убрать: там ID назначает магазин.
